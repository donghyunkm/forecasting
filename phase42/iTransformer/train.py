"""
iTransformer — Vital Sign Forecasting, Complete Windows (Phase 4.2)
...
def plot_training_curves(train_losses, val_losses, output_dir):
    ...
    ax.set_title('iTransformer — Training Curves (Phase 4.2)', fontsize=14)
...
# ==============================================================================
def main():
    parser = argparse.ArgumentParser(description='Train iTransformer for Phase 4.2')
    ...
    print('=' * 80)
    print('iTransformer — Vital Sign Forecasting, Complete Windows (Phase 4.2)')
    print('=' * 80)
    print()
