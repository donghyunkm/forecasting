...
Phase 4.2: Complete windows (no masks), historical has 5 features (4 vitals + 1 time).
...
def main(num_epochs=100, num_samples=5):
    ...
    for plot_i, idx in enumerate(indices):
        ...
        for s in range(NUM_SIGNALS):
            ...
            # Plot historical (all real in phase42, no masks)
            ...
            # Mark imputed future values (should be rare/none in phase42)
        ...
        axes[0].set_title(
            f'iTransformer Phase 4.2 — Full Forecast (Sample {plot_i + 1})\n'
