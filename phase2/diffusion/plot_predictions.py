#!/usr/bin/env python3
"""
plot_predictions.py - Visualize heart rate predictions vs ground truth (Diffusion).
...
Usage:
    ...
    python plot_predictions.py --epochs 100 --input-length 7500 --target-length 7500
"""
...
def plot_time_series(predictions, targets, metrics, output_dir, num_points=500):
    ...
    title = 'Diffusion — Heart Rate Predicted vs Ground Truth'
    if metrics:
...
def plot_scatter(predictions, targets, metrics, output_dir):
    ...
    ax.set_title('Diffusion — Heart Rate Predicted vs Actual', fontsize=12, fontweight='bold')
...
def plot_error_distribution(predictions, targets, metrics, output_dir):
    ...
    plt.suptitle('Diffusion — Heart Rate Prediction Error Analysis',
...
def plot_bland_altman(predictions, targets, metrics, output_dir):
    ...
    ax.set_title('Diffusion — Bland-Altman Plot', fontsize=12, fontweight='bold')
...
def main(num_epochs=None, input_length=None, target_length=None):
    ...
    print("=" * 60)
    print("Plotting Diffusion HR Predictions vs Ground Truth")
    print("=" * 60)
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Plot diffusion HR predictions')
