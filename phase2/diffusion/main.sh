#!/bin/bash
#SBATCH --job-name=diffusion_hr_predict
#SBATCH --partition=gl40s_short
#SBATCH --gres=gpu:l40s:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=12:00:00
#SBATCH --output=/gpfs/home/dk5565/forecasting/phase2/diffusion/logs/train_%j.out
#SBATCH --error=/gpfs/home/dk5565/forecasting/phase2/diffusion/logs/train_%j.err

# Create logs directory
mkdir -p /gpfs/home/dk5565/forecasting/phase2/diffusion/logs
...
cd /gpfs/home/dk5565/forecasting/phase2/diffusion
...
echo "Task: Heart Rate Prediction (Diffusion)"
