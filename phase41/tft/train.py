#!/usr/bin/env python3
"""
train.py - Training script for TFT-multi vital sign forecasting (Phase 4.1).
...
def train_model(device, num_epochs=NUM_EPOCHS):
    ...
    data_props = {
        'num_historical_numeric': NUM_HISTORICAL_NUMERIC,  # 9
    ...
    ax.set_title('TFT-multi — Vital Sign Forecasting from Waveforms (Phase 4.1) — Training Curves')
    ax.legend()
...
def main(num_epochs=None):
    ...
    print("=" * 60)
    print("TFT-multi — Vital Sign Forecasting from Waveforms (Phase 4.1)")
    print("=" * 60)
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Train TFT-multi for vital sign forecasting (Phase 4.1)')
