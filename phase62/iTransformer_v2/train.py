"""
Training for Phase 6.2 v2 iTransformer — Cluster classification with label history.
Input: (B, 48, 9) = 7 corr + 1 time + 1 label history
"""
...
def main():
    ...
    ax1.set_title('iTransformer v2 — Loss')
    ...
    ax2.set_title('iTransformer v2 — Accuracy')
