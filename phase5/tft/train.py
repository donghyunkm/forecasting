#!/usr/bin/env python3
"""
Phase 5 TFT Training: Temporal Fusion Transformer for vital sign forecasting.

Input: 72 steps (6h) × 12 features (7 correlations + 4 vitals + 1 time)
...
def get_config():
    """Build TFT configuration."""
    config = OmegaConf.create({
        'task_type': 'regression',
        'target_window_start': None,
        'data_props': {
            'num_historical_numeric': 12,
...
def save_training_curves(train_losses, val_losses, output_dir):
    ...
    ax.set_title('Phase 5 TFT Training Curves')
    ax.legend()
...
def main():
    parser = argparse.ArgumentParser(description='Phase 5 TFT Training')
