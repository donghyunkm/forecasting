#!/usr/bin/env python3
"""
Phase 5 Ablation TFT Preprocessing: Load pre-computed .pt files into DataLoaders.

Vitals-only ablation study:
  - historical_ts_numeric: (N, 72, 5) = 4 vitals + 1 time position
  - target: (N, 24, 4) = 4 vitals
  - target_mask: (N, 24, 4)
  - future_ts_numeric: (N, 24, 1)
  - static_feats_numeric: (N, 1)

Provides PreloadedDataset class and create_dataloaders() function.
"""
