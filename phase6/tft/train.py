#!/usr/bin/env python3
"""
Phase 6 TFT Training: Temporal Fusion Transformer for correlation forecasting.
...
def get_config():
    """Build TFT configuration for Phase 6 (correlation-only, point prediction)."""
...
def save_training_curves(train_losses, val_losses, output_dir):
    ...
    ax.set_title('Phase 6 TFT Training Curves (Correlation Forecasting)')
    ax.legend()
...
def main():
    parser = argparse.ArgumentParser(description='Phase 6 TFT Training')
