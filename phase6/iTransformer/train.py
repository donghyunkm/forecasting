"""
Training script for Phase 6 iTransformer — Correlation-Only Forecasting.
...
def save_training_curves(train_losses, val_losses, best_epoch, output_dir):
    ...
    ax.set_title('iTransformer Training Curves (Phase 6 — Correlation Forecasting)')
    ax.legend()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train iTransformer for correlation forecasting")
